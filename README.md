...
flowchart TB
    ...
    subgraph AWS["☁️ AWS Cloud (ap-northeast-1)"]
        ...
        subgraph API["🌐 API Layer"]
            ...
            ChatURL["Lambda Function URL<br/>Streaming対応"]
        end
        ...
        subgraph Storage["💾 Storage"]
            S3["Amazon S3<br/>ドキュメント保存"]
            DynamoDB["DynamoDB<br/>メタデータ / 履歴"]
        end
...
│  Phase 1: 論理削除（同期）                                    │
├─────────────────────────────────────────────────────────────┤
│  1. DELETE /documents/{id} リクエスト受信                    │
│     ↓                                                         │
│  2. DynamoDB: status を DELETED に更新                       │
│     - TTL を設定（24時間後に自動削除）                        │
│     ↓                                                         │
